"""Third Fable rep (cohort-v2-n2-makeup3): ONE Fable 5 arm, same frozen draw /
prompt / budgets. Runs concurrently with makeup2. Usage: python3 run_makeup3_fable.py"""
import json, sys
...
out = evalkit.run_cohort(
    ...
    cohort_name="cohort-v2-n2-makeup3",
